...
def track_v7g(frames, seed_frame, seed_pos, cache,
              min_conf=0.10,
...
def main():
    ...
    print("\n--- Baseline v7g ---")
    pos = track_v7g(frames, seed_frame, seed_pos, cache)
    ...
    hand_tuned = [
        # KEY FIX: abc_protect_conf=0.65 lets abc_filter remove f265@c=0.51, f1020@c=0.63
        # chain_margin=350 keeps f295 (dev=319px < 350), removes f1020 (dev=522px > 350)
        ...
        # abc_protect=0.70 — even stricter protection
        dict(min_conf=0.05, hard_reset_conf=0.50, abc_protect_conf=0.70,
             speed_limit=120, vel_decay=0.85,
             abc_ratio=0.6, hc_thresh=0.55, chain_margin=350, gap_margin=260,
             min_gap_for_filter=8, interp_max_gap=120, y_off=65, x_off=0,
             person_accept_r=150, person_conf_min=0.30,
             use_kalman_smooth=True, kalman_q=1.0),
        # abc_protect=0.65 with abc_ratio=0.65 for stronger FP rejection
        dict(min_conf=0.05, hard_reset_conf=0.50, abc_protect_conf=0.65,
             speed_limit=120, vel_decay=0.85,
             abc_ratio=0.65, hc_thresh=0.55, chain_margin=350, gap_margin=260,
             min_gap_for_filter=8, interp_max_gap=120, y_off=65, x_off=0,
             person_accept_r=150, person_conf_min=0.30,
             use_kalman_smooth=True, kalman_q=1.0),
        # abc_protect=0.65 with hc_thresh=0.50 (f940@0.56 is HC anchor)
        dict(min_conf=0.05, hard_reset_conf=0.50, abc_protect_conf=0.65,
             speed_limit=120, vel_decay=0.85,
             ...
             person_accept_r=150, person_conf_min=0.30,
             use_kalman_smooth=True, kalman_q=1.0),
        # abc_protect=0.65 with gap_margin=280
        dict(min_conf=0.05, hard_reset_conf=0.50, abc_protect_conf=0.65,
             speed_limit=120, vel_decay=0.85,
             ...
             person_accept_r=150, person_conf_min=0.30,
             use_kalman_smooth=True, kalman_q=1.0),
        # abc_protect=0.65 with chain_margin=400
        dict(min_conf=0.05, hard_reset_conf=0.50, abc_protect_conf=0.65,
             speed_limit=120, vel_decay=0.85,
        ...
        dict(min_conf=0.05, hard_reset_conf=0.50, abc_protect_conf=0.65,
             ...
             person_accept_r=150, person_conf_min=0.30,
             use_kalman_smooth=True, kalman_q=1.0),
        # abc_protect=0.65 min_gap=6
        dict(min_conf=0.05, hard_reset_conf=0.50, abc_protect_conf=0.65,
             speed_limit=120, vel_decay=0.85,
             abc_ratio=0.6, hc_thresh=0.55, chain_margin=350, gap_margin=260,
             min_gap_for_filter=6, interp_max_gap=120, y_off=65, x_off=0,
             person_accept_r=150, person_conf_min=0.30,
             use_kalman_smooth=True, kalman_q=1.0),
        # Prev best from v7f grid search, now with abc_protect=0.65
        dict(min_conf=0.12, hard_reset_conf=0.50, abc_protect_conf=0.65,
             ...
             person_accept_r=150, person_conf_min=0.30,
             use_kalman_smooth=True, kalman_q=1.0),
        # abc_protect=0.65 with tighter gap_margin=240
        dict(min_conf=0.05, hard_reset_conf=0.50, abc_protect_conf=0.65,
             speed_limit=150, vel_decay=0.85,
    ...
    for _ in range(90):
        random_combos.append(dict(
            ...
            abc_protect_conf  = random.choice([0.60, 0.62, 0.65, 0.68, 0.70, 0.75]),
            ...
            chain_margin      = random.choice([250, 300, 350, 400, 450]),
    ...
    for ci, params in enumerate(all_combos):
        pos = track_v7g(frames, seed_frame, seed_pos, cache, **params)
        tr, w30, w50, med, sc = evaluate(pos, labels)
    ...
    with open('tracking_analysis_v7g.txt', 'w') as f:
    ...
    print("\nSaved to tracking_analysis_v7g.txt")

    if args.render:
        render_video(frames, best_pos, labels, 'tracking_v7g_winner.mp4')
